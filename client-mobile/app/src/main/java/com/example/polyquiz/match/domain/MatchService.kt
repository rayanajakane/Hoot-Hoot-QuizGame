...
object MatchService {
    ...
    fun createMatch(hostId: String, hostUsername: String, context: Context, partyConfigs: PartyConfig = PartyConfig(false, false), isClassicMode : Boolean = false){
    ...
    fun saveBackupGame(id: String, hostId: String , hostUsername: String, componentContext:Context,partyConfigs: PartyConfig = PartyConfig(false, false)){
            return backupService.add(
                ...
                onSuccess = { response ->
                    ...
                    currentGame = game
                    println("Game saved")
                    createMatch(hostId, hostUsername, componentContext, partyConfigs )
                },
